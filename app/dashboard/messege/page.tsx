...
const isCloneIconDisabled = (e:any) => isChief(e.row.data.Position);

const isDeleteIconVisible = (e:any) => !isChief(e.row.data.Position);
...
const page = () => {
  ...
  const onCloneIconClick = useCallback((e:any) => {
