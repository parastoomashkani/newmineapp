    ...
    <div className="border-b border-gray-900/10 pb-12 ">
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-4">
          <label htmlFor="titel" className="block text-lg font-medium leading-6 text-gray-900 ml-20 "> عنوان </label>
          <div className="mt-2">
            <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
              <input type="text" name="username" id="titel" autoComplete="titel" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="  معدن طلا "/>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-full">
          ...
          چند جمله در مورد عنوان /معدن  بنویسید.
          </p>
        </div>


        <div className="col-span-full">
          <label htmlFor="cover-photo" className="block text-lg text-center font-medium leading-6 text-gray-900"> عکس   را قرار دهید </label>
