...
<form  className="relative border border-gray-100 space-y-3 max-w-screen-md mx-auto rounded-md bg-slate-300  inset-y-0 left-0 	 p-6 shadow-xl lg:p-10" onSubmit={handelsubmit} >
