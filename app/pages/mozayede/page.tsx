    ...
    <div className='bg-slate-50'>
      ...
      <div >
        <div className="container p-8 ">
          ...
          <br />
          <br />
          <div className="grid grid-cols-1 place-items-center xl:grid-cols-3  pt-10 top-[100px] p-8 m-8">

            <div className='p-8 border-2  rounded border-slate-200 shadow-xl bg-slate-100	size-40 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-blue-200		 duration-300'>
